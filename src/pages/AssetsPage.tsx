...
export const AssetsPage: React.FC<AssetsPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div id="novaquant-assets-page" className="space-y-6 max-w-7xl mx-auto pb-12">
      ...
      {/* Non-Custodial Security & Architecture Banner */}
      <div className="bg-gradient-to-r from-[#022824] via-[#033631] to-[#022824] border border-[#bf9b42]/30 rounded-xl p-5 shadow-lg">
        <div className="flex flex-col md:flex-row items-start md:items-center gap-4">
          <div className="w-10 h-10 rounded-lg bg-[#bf9b42]/15 border border-[#bf9b42]/40 flex items-center justify-center shrink-0">
            <ShieldCheck className="w-5 h-5 text-[#bf9b42]" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-2">
              <h4 className="text-sm font-semibold text-[#f3ebd7]">
                Non-Custodial Balance Architecture
              </h4>
              <span className="px-2 py-0.5 rounded text-[10px] font-mono font-bold bg-[#bf9b42]/20 text-[#bf9b42] border border-[#bf9b42]/30">
                FUNDS REMAIN ON EXCHANGE
              </span>
            </div>
            <p className="text-xs text-[#a2b5af] leading-relaxed">
              The Bot Capital is <strong className="text-[#f3ebd7]">not a separate cryptocurrency wallet</strong>. Your funds remain securely in your connected Binance, Bybit, or Bitget account. NovaQuant strictly reads your real available balance and executes automated trades via API.
            </p>
          </div>
        </div>

        {/* Live Architecture Flow Diagram */}
        <div className="mt-4 pt-4 border-t border-[#044a43]/80 grid grid-cols-1 sm:grid-cols-4 gap-2 text-center text-xs">
          <div className="bg-[#021f1c]/70 p-2.5 rounded border border-[#044a43] flex flex-col items-center justify-center">
            <span className="text-[10px] text-[#8ea49e] uppercase font-semibold">Step 1</span>
            <span className="font-bold text-[#f3ebd7] mt-0.5">Exchange API</span>
            <span className="text-[10px] text-[#bf9b42]">Binance / Bybit / Bitget</span>
          </div>
          <div className="bg-[#021f1c]/70 p-2.5 rounded border border-[#044a43] flex flex-col items-center justify-center">
            <span className="text-[10px] text-[#8ea49e] uppercase font-semibold">Step 2</span>
            <span className="font-bold text-[#f3ebd7] mt-0.5">Retrieve Real Available</span>
            <span className="text-[10px] text-emerald-400">Excludes locked & margin</span>
          </div>
          <div className="bg-[#021f1c]/70 p-2.5 rounded border border-[#044a43] flex flex-col items-center justify-center">
            <span className="text-[10px] text-[#8ea49e] uppercase font-semibold">Step 3</span>
            <span className="font-bold text-[#f3ebd7] mt-0.5">NovaQuant Backend</span>
            <span className="text-[10px] text-[#bf9b42]">Auto-Sets Bot Capital</span>
          </div>
          <div className="bg-[#021f1c]/70 p-2.5 rounded border border-[#044a43] flex flex-col items-center justify-center">
            <span className="text-[10px] text-[#8ea49e] uppercase font-semibold">Step 4</span>
            <span className="font-bold text-[#f3ebd7] mt-0.5">Automated Execution</span>
            <span className="text-[10px] text-emerald-400">Bot Capital = Available</span>
          </div>
        </div>
      </div>
